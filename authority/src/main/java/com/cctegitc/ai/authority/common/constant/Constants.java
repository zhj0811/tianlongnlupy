package com.cctegitc.ai.authority.common.constant;
...
public final class Constants {
    ...
    public static final String D_ID = "deptId";
     ...
     * 权限服务地址
     */
    public static final String USER_INFO_URL = "http://192.168.30.182:8089";

    /**
     * 此数据
     */
    public static final String THIS_DATA = "此数据";

    /**
     * 文件名检验重复
     */
    public static final String FILE_NAME_REPEAT = "已存在";

    /**
     * 不存在
     */
    public static final String IS_NOT_NULL = "已存在";
     ...
     * 设备二维码字符串
     */
    public static final String EQUIP_QR = "equip-qr";

    /**
     * web指标资料字符串
     */
    public static final String WEB_INDICATOR = "web-indicator";
