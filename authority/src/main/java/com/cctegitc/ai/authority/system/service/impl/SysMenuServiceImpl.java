...
import com.cctegitc.ai.authority.system.mapper.SysMenuMapper;
import com.cctegitc.ai.authority.system.mapper.SysRoleMapper;
import com.cctegitc.ai.authority.system.mapper.SysRoleMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService {
    ...
    @Autowired
    private SysMenuMapper _menuMapper;
    ...
    @Override
    public List<SysMenu> selectMenuTreeByRole(String role) {
        List<SysMenu> menus = _menuMapper.selectMenuTreeByRole(role);
        return getChildPerms(menus, 0);
    }
    ...
    public String checkMenuNameUnique(SysMenu menu) {
        ...
        SysMenu info = _menuMapper.checkMenuNameUnique(menu.getMenuName(), menu.getParentId());
